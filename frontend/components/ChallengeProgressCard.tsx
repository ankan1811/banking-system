  ...
  return (
    <>
      <div className="glass-card p-5 space-y-3">
        ...
        <div className="flex items-center justify-between text-xs">
          {isNoSpend ? (
            ...
            <span className="text-slate-400">
              ${Number(currentSpent).toFixed(2)} / ${Number(targetAmount).toFixed(2)} saved
            </span>
          ) : (
            <span className="text-slate-400">
              ${Number(currentSpent).toFixed(2)} / ${Number(targetAmount).toFixed(2)} spent
            </span>
          )}
      ...
      <ConfirmModal
        ...
        description={`"${challenge.title}" will be marked as abandoned and your streak may be affected.`}
        confirmText="Abandon"
