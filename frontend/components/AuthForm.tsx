      ...
      {user ? (
        ...
        <>
          ...
          >
            ...
            <div className="w-full h-[44px] flex items-center justify-center gap-3 bg-slate-700/50 text-slate-400 text-sm rounded-xl">
              {backendCold ? 'Waiting for server...' : 'Loading Google Sign-In...'}
            </div>
          </div>
