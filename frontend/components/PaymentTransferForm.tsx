...
import { createTransfer } from "@/lib/api/transfers.api";
import { createTransaction } from "@/lib/api/transactions.api";
import { getBank, getBankByAccountId } from "@/lib/api/banks.api";
      ...
      <form onSubmit={form.handleSubmit(submit)} className="flex flex-col gap-6">
              ...
              <FormItem>
                <div className="payment-transfer_form-item">
                  <div className="payment-transfer_form-content">
                    <FormLabel className="text-14 font-medium text-slate-300">
                      Select Source Bank
                    </FormLabel>
                    <FormDescription className="text-12 font-normal text-slate-400">
                  ...
                  <div className="flex w-full flex-col">
                    ...
                    <FormMessage className="text-12 text-rose-400" />
                  </div>
                </div>
              </FormItem>
            )}
        ...
        <div className="glass-card p-5 space-y-6">
          <div>
            ...
            <p className="text-14 font-normal text-slate-400 mt-1">
          ...
          <FormField
            ...
            name="email"
            render={({ field }) => (
              <FormItem className="border-t border-white/[0.06] pt-5">
                <div className="payment-transfer_form-item">
                  <FormLabel className="text-14 w-full max-w-[280px] font-medium text-slate-300">
