...
// Validators (kept in sync with shared/validators.ts)
export const authFormSchema = (type: string) => z.object({
  firstName: type === 'sign-in' ? z.string().optional() : z.string().min(3),
  lastName: type === 'sign-in' ? z.string().optional() : z.string().min(3),
  address1: type === 'sign-in' ? z.string().optional() : z.string().max(50),
  country: type === 'sign-in' ? z.string().optional() : z.string().min(2, 'Select a country'),
  city: type === 'sign-in' ? z.string().optional() : z.string().max(50),
  state: type === 'sign-in' ? z.string().optional() : z.string().min(2, 'Select a state'),
  postalCode: type === 'sign-in' ? z.string().optional() : z.string().min(3).max(10),
  dateOfBirth: type === 'sign-in' ? z.string().optional() : z.string().min(1, 'Select your date of birth'),
